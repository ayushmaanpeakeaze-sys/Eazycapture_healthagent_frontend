          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 inline-flex items-center gap-1 rounded-md border border-ink-200 bg-ink-50 px-2 py-1 text-[11px] text-ink-700">
              ...
              <button
                ...
                className="ml-1 rounded p-0.5 text-ink-500 transition hover:bg-surface hover:text-ink-800"
              >
                {copied ? (
                  <svg
                    viewBox="0 0 24 24"
            ...
            <div className={applyResult?.ok ? "mt-4 space-y-4 opacity-60" : "space-y-4"}>
                ...
                <div>
                  ...
                  <ol className="mt-2 space-y-2">
                    {data.suggestion.human_steps.map((step, i) => (
                      <li
                        key={i}
                        className="flex items-start gap-3 rounded-lg border border-ink-200 bg-surface px-3 py-2.5 text-sm text-ink-800"
                      >
              ...
              {data.suggestion.xero_action && (
                <div>
                  ...
                  <pre className="mt-2 overflow-x-auto rounded-lg border border-ink-200 bg-scrim p-3 text-[11px] leading-relaxed text-emerald-200">
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-3.5 py-3 text-sm text-amber-800">
        ...
        {result.xero_url && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex items-center gap-1.5 rounded-md bg-surface px-2.5 py-1 text-xs font-semibold text-amber-800 ring-1 ring-amber-300 transition hover:bg-amber-100"
          >
