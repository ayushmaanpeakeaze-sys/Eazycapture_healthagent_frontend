                    ...
                    <td className="px-2 py-3">
                      {editable ? (
                        <select
                          ...
                          className="w-44 rounded-md border border-ink-200 bg-surface px-2 py-1 text-xs focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-200"
                        >
                          {accounts.map((a) => (
